...
public class LevelManager {
    ...
    private void loadBirds(int level) {
        ...
        if (level == 1) {
            ...
            Bird bird = new Bird(865, 380, (float) 1.36);
            birdArray.add(bird);

            Bird bird2 = new Bird(1230, 50, (float) 1.36);
            birdArray.add(bird2);

            Bird bird3 = new Bird(1450, 200, (float) 1.36);
            birdArray.add(bird3);

            Bird bird4 = new Bird(1530, 50, (float) 1.36);
            birdArray.add(bird4);

            Bird bird5 = new Bird(2150, 200, (float) 1.36);
            birdArray.add(bird5);

            Bird bird6 = new Bird(2510, 210, (float) 1.36);
            birdArray.add(bird6);
            ...
            Bird bird = new Bird(1100, 90, (float) 1.36);
            birdArray.add(bird);

            Bird bird2 = new Bird(1265, 40, (float) 1.36);
            birdArray.add(bird2);

            Bird bird3 = new Bird(1650, 225, (float) 1.36);
            birdArray.add(bird3);

            Bird bird4 = new Bird(1830, 385, (float) 1.36);
            birdArray.add(bird4);

            Bird bird5 = new Bird(2510, 160, (float) 1.36);
            birdArray.add(bird5);

            Bird bird6 = new Bird(3010, 160, (float) 1.36);
            birdArray.add(bird6);

            Bird bird7 = new Bird(3810, 360, (float) 1.36);
            birdArray.add(bird7);
